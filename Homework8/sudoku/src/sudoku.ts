...
// Creates the Sudoku object with the value of 2d array (sudoku game)
...
// Creates the zkApp to interact with the Sudoku game by updatnig it's state and submitting a solution
class SudokuZkApp extends SmartContract {
    ...
    // Updates the Sudoku state without making it solved
    ...
    @method submitSolution(sudokuInstance: Sudoku, solutionInstance: Sudoku) {
        // getting both the sudoku instance and the solution (prover private imput) instance for the first (public) input
